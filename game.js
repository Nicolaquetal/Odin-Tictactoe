...
const round = (()=>{
          ...
          if(currentRound<Nbround){
            ...
            if (boardgame.getWinner()==="no"){
                ...
                if(currentRound==Nbround){
                  ...
                  display.displayEndRoundMenu(result);
                  display.displayRound(currentRound+1,Nbround);
                }
            }
            else {
    ...
    const playRoundPVE = (players,firstP,Nbround)=>{
        ...
        bigcase.forEach(c => c.addEventListener('click',(e)=>{
          console.log("firstround n°"+currentRound+" firstroundP "+firstRounP);
          if(firstRounP== 1 && currentRound<Nbround){
            console.log("if1");
          ...
          if (turn ==0 && currentRound<Nbround){
            console.log("if2");
              const pos= parseInt(e.target.id[4]);
              const currentdiv = e.target;
                ...
                console.log("if3");
                  ...
                  if (boardgame.getWinner()==="no"){
                    ...
                    console.log("if5");
                      ...
                      firstRounP=(firstP+currentRound%2)%2;
                      turn=firstRounP;
                      display.displayEndRoundMenu("Egality");
...
const display = (()=>{
  ...
  const displayMainMenu = ()=>{
    ...
    function play (){
      ...
      game.launchGame(name1,name2 ,typeSelected,0,roundnb);
  ...
  const displayEndRoundMenu = (result)=>{
  ...
  return {displayMainMenu,displayEndRoundMenu,displayEndGameMenu,displayName,displayScore,displayRound}
})(); 
